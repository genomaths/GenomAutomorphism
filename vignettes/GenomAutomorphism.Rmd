...
the set of integers modulo 64. Below, in function [automorphism](https://genomaths.github.io/genomautomorphism/reference/automorphism.html) three important
...
```{r barplot_3, fig.height = 5, fig.width = 4}
