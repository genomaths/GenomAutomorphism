...
Only one indel mutation was found in the region where the spike glycoprotein
is located: 7076 - 8331.
...
```{r autm_z125}
data(autm_z125, "GenomAutomorphism")
autm_z125
```
...
```{r autm_3d}
data(autm_3d, "GenomAutomorphism")
autm_3d
```
