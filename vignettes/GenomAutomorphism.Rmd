...
The _FASTA_ file is read and the corresponding codon sequences are represented
...
codons <- codon_coord(filepath = url, 
                      cube = "ACGT", 
                      group = "Z64", 
                      start = 1, 
                      end = 102,
...
```{r barplot, fig.height = 4, fig.width = 3}
...
mtext(side = 1,line = -1.2, at = c(0.7, 1.9, 3.1),
      text = paste0( counts ), 
...
```{r barplot_2, fig.height = 4, fig.width = 3}
