...
#' on \eqn{\mathbb{Z}_4} and '0' in \eqn{\mathbb{Z}_5}. In \eqn{\mathbb{Z}_{64}} the symbol 'NA' will be returned for codons
...
#' seqRanges(coord)
#'
#' ## DNA codon representation in the Abelian group \eqn{\mathbb{Z}_{64}}
#' coord <- get_coord(
#'     x = aln,
#'     base_seq = FALSE,
#'     cube = "ACGT",
