...
#' @docType package
#' @title GenomAutomorphism: An R package to compute the autimorphisms between 
...
#' pairwise aligned DNA sequences represented as elements from a Genomic Abelian
#' group as described in reference (1). In a general scenario, whole
...
#' groups or more specifically Abelian \eqn{p}-groups. Basically, we propose the
#' representation of multiple sequence alignments (MSA) of length \eqn{N} as a
#' finite Abelian group created by the direct sum of homocyclic Abelian group of
#' \emph{prime-power order}.
#' @references 
#' \enumerate{
...
#' 
#' \item 5. M. V José, E.R. Morgado, R. Sánchez, T. Govezensky, The 24 possible
